...
Source0:                https://github.com/theforeman/%{upstream_name}/archive/v%{upstream_version}.tar.gz#/%{upstream_name}-%{upstream_version}.tar.gz
...
%changelog
* Wed Oct 11 2023 RDO <dev@lists.rdoproject.org> 10.1.0-1
- Update to 10.1.0
